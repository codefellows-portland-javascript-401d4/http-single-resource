...
const server = http.createServer(function (request, response) {
    ...
    if (request.url === '/tacos' && request.method === 'GET') {
    ...
    } else if (request.url === '/tacos/junk' && request.method === 'DELETE') {
        tacoStore.removeFile('tacos/junk.json').then(data => {
            console.log(data);
            response.statusCode = 200;
        ...
        bodyReader(request, (err, data) => {
            if(err) {
                ...
                response.statusCode = 200;
                response.write('your data has been posted');
        ...
        // tacoStore.writeFile('tacos/pescado.json').then(data => {
        //     console.log(data);
        //     response.statusCode = 200;
        //     response.end();
        // })
    ...
    // } else if (request.url === '/tacos/chorizo' && request.method === 'POST') {
    //     tacoStore.openFile('tacos/chorizo.json', 'a').then(data => {
    //         console.log(data);
    //         response.statusCode = 200;
    //         response.end();
    //     })
    ...
    //             console.log(err);
    //         });
    //     tacoStore.appendFile('chorizo.json', '{"tortilla":"corn","filling":"pork"}').then(data => {
    //         console.log(data);
    //         response.statusCode = 200;
    //         response.end();
    //     })
