...
module.exports = http.createServer((req, res) => {
  ...
  //home page
  if (req.method === 'GET' && url.pathname === '/' &&! queryData.team) {
...
// PUT - edit an existing team in JSON format via body-reader.js and via ?team=Cubs, for example
